...
export const Route = createFileRoute("/employee/orders")({
  head: () => ({ meta: [{ title: "Employee Orders — MININOTE" }] }),
...
function EmployeeOrdersPage() {
  ...
  const setOrderStatus = useEmployeeStore((s) => s.setOrderStatus);
  ...
  return (
    <div className="space-y-4">
      <div className="rounded-2xl border-2 border-black bg-white p-5 shadow-md">
        ...
        <p className="mt-1 text-sm text-muted-foreground">Employee order handling (dummy).</p>
      </div>
